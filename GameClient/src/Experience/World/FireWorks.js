...
export default class FireWorks {
    ...
    Init() {
        ...
        this.particle_params = [
            ...
            },
            {
                ...
                colors: [
                    ...
                    new THREE.Color("#dddd00"),
                    // new THREE.Color("#ffff00"),
                    new THREE.Color("#dddd88"),
                    // new THREE.Color("#ffffff")
                ],
        ...
        this.effect_obj = new EffectComponent(this.particle_params, [{ name: "shootingStar" }])
    ...
    Move(from, to, duration) {
        ...
        tmp_obj_peak.position.setComponent(1, to.y)

        tmp_obj_from.lookAt(tmp_obj_peak.position)
        tmp_obj_from.rotateX(-Math.PI / 24)


        tmp_obj_peak.lookAt(to)
        tmp_obj_peak.rotateX(0)
        ...
        gsap.timeline()
            .to(this.instance.position, { ease: "Power1.easeOut", y: to.y, duration: duration})
