...
const godFavorsPower = {
    ...
    "Freyja": function( situation, data, superVisor, game) {
        ...
        let dice_template = [
            { weapon: "axe", token: false },
            { weapon: "shield", token: false },
            { weapon: "axe", token: false },
            { weapon: "helmet", token: false },
            { weapon: "arrow", token: true },
            { weapon: "steal", token: true }
        ]
        ...
        for(let i=0; i<newDiceCnt; i++){
            ...
            let nDiceIndex = random.integer(0, 5)
            let nDirIndex = random.integer(0, 5)
            ...
            let newDice = {
                ...
                weapon : dice_template[random.integer(0, 5)].weapon,
                token : dice_template[random.integer(0, 5)].token,
                state : "waiting",
                power : 1
            }
