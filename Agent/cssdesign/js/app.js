...
axios.get("/html/component/rollphase.html").then((ret)=>{
    resources["rollphase-html"] = ret.data
    let situation_panel = new SituationPanel()
})
...
class SituationPanel{
    constructor(){
        ...
        for(let i=0; i<6; i++){
            ...
            nElement.innerHTML = resources["rollphase-html"]
