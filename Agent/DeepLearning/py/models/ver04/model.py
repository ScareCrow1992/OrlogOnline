...
def TrainingModel():
    ...
    embedding_layer = keras.layers.Dense(16, use_bias=False)
    ...
    A = keras.layers.Dense(256, activation='relu')(concatenated_data)
    B = keras.layers.Dense(256, activation='relu')(A)
    C = keras.layers.Dense(256, activation='relu')(B)
    D = keras.layers.Dense(256, activation='relu')(C)
    E = keras.layers.Dense(256, activation='relu')(D)
    F = keras.layers.Dense(128, activation='relu')(E)
    G = keras.layers.Dense(64, activation='relu')(F)
    H = keras.layers.Dense(32, activation='relu')(G)
    I = keras.layers.Dense(16, activation='relu')(H)
    output = keras.layers.Dense(1)(I)
