...
export default function (agent_index, godfavor_stat, players_info, power, godfavorNameIndex, input_) {
    ...
    let target_health_stone_index
    

    switch(godfavorNameIndex){
        // Frigg
        case 5:
            let reroll_cnt = godfavor_stat.effectValue[power.level]
        ...
        // Loki
        case 9:
            ban_cnt = godfavor_stat.effectValue[power.level]
        ...
        // Odin
        case 11:
            // consumed_health_stone_cnt = input_
            ...
            // console.log(target_health_stone_index)
