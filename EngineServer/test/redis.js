...
async function main() {
    ...
    await client.publish("socket-0", "hello socket0")

    // await client.select(0);
    // let value = await client.get("wow")
    // console.log(value)

    // await client.select(1);
    // value = await client.get("wow")
    // console.log(value)
    ...
    // client.publish("socket-0", "hello socket0")
    // client.publish("socket-1", "hello socket1")
    // client.publish("socket-2", "hello socket2")
    // client.publish("socket-3", "hello socket3")
