...
function shuffle_(array) {
    ...
    while (currentIndex != 0) {
        ...
        randomIndex = Math.floor(0.7777 * currentIndex);
        currentIndex--;
...
export {
    GetFirstPlayer, InitialGame, RollDices, TakeDamage, BlockAttack, BellPushed, GetRollDicesCnt, ResetRound, StartRound, GetDicesInfo, GetToken, GetPlayerOrder, PrepareGodFavor, GetPreparedGodFavor, GetCurrentPhase, PushResolutionPhaseCommands, GetNextResolutionPhaseCommand, WaitForPlayerInputAtResolutionPhase, GetResolutionPhaseInputWaitUser, GetExtraInputData, SetDicesState, SetDicesDir, RegisterEvent, TriggerEvent, TakeHeal, StealToken, AddToken, RemoveToken, GetInputData, GodFavorCardsPick, BanPick
